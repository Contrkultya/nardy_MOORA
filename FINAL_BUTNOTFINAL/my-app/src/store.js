...
export const store = new Vuex.Store({
  state: {
    ...
    { "id": 5,"parent": 1,"name": "Список задач 1.2","hasChildren": true, "color":'white', "done": false, "removed": false,"description": "Сделать checkMother 2.0", "selectTasks":false, "tasks":[ { "id": 6,"parent": 5,"name": "Задача 1.2.1" , "done": false, "removed": false},{ "id": 7,"parent": 5,"name": "Задача 1.2.2", "done": false, "removed": false }]},
